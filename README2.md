...
```
Verification of mpi without open mp vs non parallel version
...
Verification of mpi with open mp vs non parallel version
Test 0 passed: -118340.691 == -118340.691
Test 1 passed: -118340.691 == -118340.691
Test 2 passed: 3109308.378 == 3109308.378
Test 3 passed: 2047534.156 == 2047534.156
...
| Количество OpenMP потоков | Теоретический максимум ускорения | Ускорение OpenMP   | Ускорение OpenMP и MPI в совместном режиме |
|------|-------------|----------|--------------|
